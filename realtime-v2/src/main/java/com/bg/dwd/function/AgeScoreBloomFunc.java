 ...
 *  能够在分布式环境下保持状态一致性
 */
public class AgeScoreBloomFunc extends RichFilterFunction<JSONObject> {

    private static final Logger logger = LoggerFactory.getLogger(AgeScoreBloomFunc.class);
     ...
     */
    public AgeScoreBloomFunc(int expectedInsertions, double falsePositiveRate) {
    ...
    public boolean filter(JSONObject value) throws Exception {
        ...
        long unique = value.getJSONObject("user").getInteger("id");
        long tsMs = value.getJSONObject("user").getLong("ts_ms");
